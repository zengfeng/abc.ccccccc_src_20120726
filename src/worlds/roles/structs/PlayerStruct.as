package worlds.roles.structs
{
    ...
    public class PlayerStruct extends BaseStruct
    {
		...
		public var requestedAvatarVer: Number = -1;
		public var isAvatarInitRequested:Boolean = false;
		...
		public var walktimeStart:Number = 0;
		...
		public function get isNewestAvatarRequested():Boolean
		{
			return newAvatarVer == requestedAvatarVer;
		}
