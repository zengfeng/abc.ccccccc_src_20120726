package worlds.apis
{
	...
	public class MapUtil
	{
		...
		public static function setCurrentMapId(mapId : int) : void
		{
			...
			hasMask = currentMapStruct.hasMask;
		}
		...
		{
			return getGatePosition(toMapId, mapId);
		...
		// 地图是否玩家限屏
		// =====================
		private static var playerNoLimitMap : Array = [42, 43, 44, 30, 31, 32];

		public static function isLimitPlayer(mapId : int = 0) : Boolean
		{
			return GBTest.historyStartup;
			if (mapId == 0) mapId = currentMapId;
			return playerNoLimitMap.indexOf(mapId) == -1 && !MapUtil.isDuplMap(mapId);
		}
	}
}
