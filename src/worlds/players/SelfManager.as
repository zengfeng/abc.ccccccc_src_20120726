package worlds.players
{
	...
	*/
	public class SelfManager
	{
		...
		{
			player = PlayerFactory.instance.makeSelfPlayer(playerStruct.name, playerStruct.colorStr, playerStruct.heroId, playerStruct.clothId, playerStruct.rideId);
		}
		...
		public function reset() : void
		{
			...
			player.cacheOut();
			player.setNeedMask(MapUtil.hasMask);
			...
			player.initPosition(playerStruct.x, playerStruct.y, playerStruct.speed, playerStruct.walking, playerStruct.walkTime, playerStruct.fromX, playerStruct.fromY, playerStruct.toX, playerStruct.toY, MoveProessorType.TIME);
			var directionPoint : Point = MapUtil.getGateCenter();
			player.setStandDirection(directionPoint.x, directionPoint.y);
			...
			SelfMediator.cStandDirection.register(player.setStandDirection);
