package worlds.mediators
{
	...
	*/
	public class SelfMediator
	{
		...
		public static const sChangeCloth:MSignal = new MSignal(int);
		public static const sChangeRide:MSignal = new MSignal(int);
		public static const cStandDirection:Call = new Call();
	}
}
