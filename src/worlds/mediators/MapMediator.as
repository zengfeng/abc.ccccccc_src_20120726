package worlds.mediators
{
	...
	*/
	public class MapMediator
	{
		...
		public static const sInstallReady:MSignal = new MSignal();
		public static const sInstallComplete : MSignal = new MSignal();
		public static const sUnstallComplete:MSignal = new MSignal();
		public static const sChangeMapStart:MSignal = new MSignal();
		public static const sChangeMapEnd:MSignal = new MSignal();
		public static const sEnterDupl:MSignal = new MSignal();
		// ---------------------------------------
		/** 是否绑定卷动频幕args=[value:Boolean] */
		public static const cbBindScorll : Callback = new Callback();
		...
		// ---------------------------------------
		public static const cbMouseEnabled : Callback = new Callback();
		public static const cMouseEnabled : Call = new Call();
		public static const cMouseClick:Call = new Call();
		public static const sMouseWalk : MSignal = new MSignal(int, int);
		...
		public static const cShow:Call = new Call();
		public static const cHide:Call = new Call();
