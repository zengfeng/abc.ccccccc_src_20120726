...
package com.protobuf
{
	...
	public final class ReadUtils {
		...
		public static function read$TYPE_MESSAGE(input : IDataInput, message : Message) : Message {
			const length : uint = read$TYPE_UINT32(input);
...
//				throw new IOError("Invalid nested message");
		...
		public static function readPackedRepeated(input : IDataInput, readFuntion : Function, value : *) : void {
			const length : uint = read$TYPE_UINT32(input);
			if (input.bytesAvailable < length) {
				throw new IOError("Invalid message length: " + length);
			}
