package game.net.data.StoC {
	/**
	 * Server to Client 协议号0xBC
	 **/
	import com.protobuf.*;
	import flash.utils.IDataInput;
	import flash.errors.IOError;
	import game.net.data.StoC.PurchaseInfo;
	public dynamic final class SCListPurchase extends com.protobuf.Message {
		 /**
		  *@purchase   purchase
		  **/
		...
		override public final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 2:
					if (total$count != 0) {
						throw new flash.errors.IOError('Bad data format: SCListPurchase.total cannot be set twice.');
					}
					++total$count;
