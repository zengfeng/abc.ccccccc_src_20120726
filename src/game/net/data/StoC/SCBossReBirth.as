package game.net.data.StoC {
	/**
	 * Server to Client 协议号0x2E5
	 **/
	import com.protobuf.*;
	import flash.utils.IDataInput;
	import flash.errors.IOError;
	public dynamic final class SCBossReBirth extends com.protobuf.Message {
		 /**
		  *@result   result
		  **/
		...
		override public final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (result$count != 0) {
						throw new flash.errors.IOError('Bad data format: SCBossReBirth.result cannot be set twice.');
					}
					++result$count;
