package game.module.userPanel {
	 ...
	 * @author yangyiqiang
	 */
	public class GiftPanel extends GInfoWindow {
		...
		private function addHintText() : void {
			addChild(UICreateUtils.createTextField("有新手礼包，是否立即使用？", null, 190, 20, 10, 8, TextFormatUtils.panelContent));
		}
		...
		private function okButton_clickHandler(event : MouseEvent) : void {
			...
			ManagePack.useItem(item.id, item.binding, 1, 0);
			this.hide();
		}
	}
}
